  ...
  async register({ name, email, password, ipAddress, userAgent }) {
    ...
    if (existingUser.rows.length > 0) {
      ...
      if (isVerified) {
        ...
        // Allow updating existing unverified account with new password and new OTP
        ...
        await db.query(
          `UPDATE users 
           SET name = $1, password_hash = $2, verification_token_hash = $3, verification_token_expiry = $4
           WHERE id = $5`,
