...
export default function AdminDashboardPage({ onNavigate }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Admin Banner */}
      <div className="p-6 md:p-8 rounded-2xl bg-gradient-to-r from-amber-950/40 via-slate-900 to-slate-900 border border-amber-500/20 mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono font-bold bg-amber-500/20 text-amber-300 border border-amber-500/30 px-2 py-0.5 rounded uppercase">
                ADMIN CONSOLE
              </span>
            </div>
            <p className="text-slate-400 text-sm mt-0.5">Control panel & platform telemetry</p>
          </div>
        </div>

        <button
          onClick={fetchMetrics}
          className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm rounded-xl border border-slate-700 flex items-center gap-2 transition-colors"
        >
          <Activity size={15} />
          Refresh Telemetry
        </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
          ...
          <div className="text-3xl font-bold text-white font-mono">{stats.totalProblems}</div>
        ...
        <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
          ...
          <div className="text-3xl font-bold text-white font-mono">{stats.totalSubmissions}</div>
        ...
        <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
          ...
          <div className="text-base font-semibold text-emerald-400 flex items-center gap-2 mt-1.5">
