    ...
    <div className="h-full w-full flex flex-col overflow-hidden bg-white dark:bg-[#1e1e1e]">
      ...
      <div className="h-9 bg-[#f8f9fa] dark:bg-[#262626] px-3 border-b border-[#e2e4e8] dark:border-[#333333] flex items-center justify-between text-xs text-slate-700 dark:text-zinc-300 shrink-0 select-none">
        <div className="flex items-center gap-2">
          <span className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-semibold text-emerald-700 dark:text-emerald-400 bg-white dark:bg-[#1e1e1e] rounded-t border-t-2 border-emerald-600 dark:border-emerald-500 shadow-sm">
      ...
      >
        {useSimpleEditor ? (
          <textarea
            ...
            className="w-full h-full p-4 bg-white text-slate-900 dark:bg-[#1e1e1e] dark:text-zinc-100 font-mono resize-none focus:outline-none leading-relaxed border-none selection:bg-emerald-500/25"
